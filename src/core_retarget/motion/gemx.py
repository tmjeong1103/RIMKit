...
from core_retarget.motion.soma_joints import SOMA77_JOINT_INDEX, SOMA77_JOINT_NAMES
...
def _skin_rig() -> tuple[NDArray[np.float64], NDArray[np.int64]]:
    ...
    if names != SOMA77_JOINT_NAMES:
        raise MotionValidationError("Packaged SOMA77 rig joint order does not match CoRe.")
